...
export async function POST(req: Request) {
  ...
  // Return a generic success message even when user is missing to avoid account enumeration.
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: 'Krushi Scan Password Reset OTP',
    text: `Hello,\n\nWe received a request to reset your Krushi Scan account password.\n\nOTP: ${otp}\n\nThis OTP is valid for the next ${otpExpiryMinutes} minutes. Please do not share this code with anyone.\n\nIf you did not request this, please ignore this email.\n\nRegards,\nKrushi Scan Team`,
    html: `
      <div style="margin:0;padding:24px;background:#f5f7f4;font-family:Segoe UI,Arial,sans-serif;color:#1f2937;">
        <div style="max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;padding:0;overflow:hidden;">
          <div style="background:linear-gradient(135deg,#1b5e20,#43a047);padding:18px 24px;">
            ...
            <p style="margin:4px 0 0 0;color:#dcfce7;font-size:12px;">Password Reset Verification</p>
          </div>
          <div style="padding:24px;">
            <p style="margin:0 0 12px 0;">Hello,</p>
            <p style="margin:0 0 12px 0;">We received a request to reset your <strong>Krushi Scan</strong> account password.</p>
            ...
            <p style="margin:0 0 12px 0;">This OTP is valid for the next <strong>${otpExpiryMinutes} minutes</strong>. Please do not share this code with anyone.</p>
